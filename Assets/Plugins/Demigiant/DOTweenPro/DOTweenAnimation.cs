        ...
        public void CreateTween(bool regenerateIfExists = false, bool andPlay = true)
        {
            ...
            switch (animationType)
            {
                ...
                case AnimationType.Jump:
                    ...
                    {
                        case TargetType.Transform:
                            tween = ((Transform)target).DOJump(endValueV3, jumpPower, numJumps, duration, optionalBool0);
                            break;
                        case TargetType.RectTransform:
#if true // UI_MARKER
                            tween = ((RectTransform)target).DOAnchorPos3D(endValueV3, duration, optionalBool0);
                    ...
                    tween = ((Transform)target).DOJump(endValueV3, jumpPower, numJumps, duration, optionalBool0);
                        ...
                        case TargetType.Rigidbody:
#if true // PHYSICS_MARKER
                            tween = ((Rigidbody)target).DOJump(endValueV3, jumpPower, numJumps, duration, optionalBool0);
#else
                    tween = ((Transform)target).DOJump(endValueV3, jumpPower, numJumps, duration, optionalBool0);
#endif
                            break;
                        case TargetType.Rigidbody2D:
#if true // PHYSICS2D_MARKER
                            tween = ((Rigidbody2D)target).DOJump(endValueV3, jumpPower, numJumps, duration, optionalBool0);
#else
                    tween = ((Transform)target).DOJump(endValueV3, jumpPower, numJumps, duration, optionalBool0);
#endif
                            break;
                ...
                case AnimationType.LocalJump:
                    tween = tweenGO.transform.DOLocalJump(endValueV3, jumpPower, numJumps, duration, optionalBool0);
                    break;
